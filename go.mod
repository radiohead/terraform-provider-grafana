...
replace (
	github.com/grafana/terraform-provider-grafana/appplatform v0.0.1 => ./appplatform
	github.com/hashicorp/terraform-exec v0.21.0 => github.com/hrmsk66/terraform-exec v0.21.0
)
...
require (
	...
	github.com/grafana/grafana/pkg/apimachinery v0.0.0-20250120114436-95d4f838898e // indirect
